...
const SignUpView = (props: Props) => {
  ...
  const { mutate: registerMerchant, isLoading: registerMerchantLoading } =
    usePostData({ url: '/auth/register', key: 'registerMerchant' });
  ...
  const signUpSteps: {
    ...
    2: {
      ...
      nextButtonText: 'Next',
      headerText: 'Create your public profile',
      subHeaderText:
        'Allow your viewers to learn more about your business by creating a public profile. This information will be visible to the public.',
      icon: <CgProfile />,
      nextButtonDisabled: false,
      hideBackButton: false,
      nextButtonAction: () => {
        Modal.confirm({
          ...
          onOk() {
            setSignUpUserFormValues({
              ...signUpUserFormValues,
              businessInfo: {
                ...signUpUserFormValues.businessInfo,
    ...
    3: {
      ...
      nextButtonAction: () => {
        registerMerchant(
          {
            data: encryptData(
              JSON.stringify({ ...signUpUserFormValues, agentCode: agentSlug })
            ),
          },
