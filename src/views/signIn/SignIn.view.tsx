...
const SignInView = (props: Props) => {
  ...
  const { redirectName, recapchaIsVerified, setRedirectName, setRedirectUrl } = useInterfaceStore((state) => state);
  ...
  return (
    <div className={styles.auth}>
      <MainWrapper
        title="Welcome Back"
        description={"Please login to your account to access your " + redirectName + "."}
      >
        {!redirectName ? (
          <div className={styles.signinCardsContainer}>
            ...
            <Card
              ...
              onClick={() =>
                setRedirectUrl(
                  process.env.NODE_ENV === "production" ? "https://portal.pyreprocessing.com" : "http://localhost:3000"
                )
              }
            >
              Partner Sign-In
